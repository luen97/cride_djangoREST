...
class Membership(CRideModel):
    ...
    invited_by = models.ForeignKey(
        ...
        related_name='invited_by' # Used because User is already referenced
    )
    ...
    # Status
    # We may need the users data created
    # while interacting in the circle, so we 
    # won't delete their membership but mark as
    # inactive
